// server/src/lib/iso3166.js
//
// ISO 3166-1 alpha-2 → alpha-3 mapping. Our country.country_code is
// stored alpha-2; the IMF Datamapper API requires alpha-3. World Bank
// accepts either, so this module is only consulted when calling IMF.
//
// Returns null when a code isn't recognised; callers should treat that
// as "skip IMF for this country" — no data lookup attempt.
...
const A2_TO_A3 = {
  ...
  BH: 'BHR', BI: 'BDI', BJ: 'BEN', BL: 'BLM', BM: 'BMU', BN: 'BRN',
  BO: 'BOL', BQ: 'BES', BR: 'BRA', BS: 'BHS', BT: 'BTN', BV: 'BVT',
  ...
  GA: 'GAB', GB: 'GBR', GD: 'GRD', GE: 'GEO', GF: 'GUF', GG: 'GGY',
  GH: 'GHA', GI: 'GIB', GL: 'GRL', GM: 'GMB', GN: 'GIN', GP: 'GLP',
  ...
  SX: 'SXM', SY: 'SYR', SZ: 'SWZ',
  TC: 'TCA', TD: 'TCD', TF: 'ATF', TG: 'TGO', TH: 'THA', TJ: 'TJK',
  TK: 'TKL', TL: 'TLS', TM: 'TKM', TN: 'TUN', TO: 'TON', TR: 'TUR',
  TT: 'TTO', TV: 'TUV', TW: 'TWN', TZ: 'TZA',
