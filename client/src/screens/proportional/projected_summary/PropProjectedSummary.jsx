          ...
          {loading ? (
            ...
            <div className="ps-page">
              ...
              <div style={{
                ...
                <b style={{ color: '#38bdf8', letterSpacing: 0 }}>UNCAPPED ULTIMATES.</b>{' '}
                          ...
                          <div style={{ marginBottom: 10 }}>
                            ...
                            <div style={{ padding: '10px 12px', borderRadius: 10, background: 'rgba(15,23,42,0.45)', border: '1px solid rgba(99,102,241,0.25)' }}>
                              <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: 12, marginBottom: 8, flexWrap: 'wrap' }}>
                                <div style={{ fontSize: 12, fontWeight: 800, color: '#c7d2fe', letterSpacing: 0 }}>RESERVING ANALYSIS — PER YEAR</div>
                                ...
                                <table className="ps-table">
                                  ...
                                  <tbody>
                                      ...
                                      return (
                                        <tr key={r.year}>
                                          ...
                                          <td className="ps-dash">
                                            <div className="ps-cell" style={{ display: 'inline-flex', padding: '2px 8px', borderRadius: 999, fontSize: 10, fontWeight: 700, letterSpacing: 0, color: t.text, background: t.bg, border: `1px solid ${t.border}` }}>
                                              {t.label.toUpperCase()}
                                            </div>
                                          </td>
                                        </tr>
                                    ...
                                    <tr className="ps-total">
                                      ...
                                      <td className="ps-dash">
                                        <div className="ps-cell" style={{ display: 'inline-flex', padding: '2px 8px', borderRadius: 999, fontSize: 10, fontWeight: 700, letterSpacing: 0, color: combinedTone.text, background: combinedTone.bg, border: `1px solid ${combinedTone.border}` }}>
                            ...
                            <div style={{ marginTop: 8, padding: '10px 12px', borderRadius: 10, background: combinedTone.bg, border: `1px solid ${combinedTone.border}` }}>
                              <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: 12, flexWrap: 'wrap' }}>
                                <div style={{ fontSize: 12, fontWeight: 800, color: combinedTone.text, letterSpacing: 0 }}>COMBINED — {combinedTone.label.toUpperCase()}</div>
            ...
            >
              <div role="dialog" aria-modal="true" className="glass" style={{ width: 'min(1380px,96vw)', maxHeight: '88vh', overflow: 'auto', borderRadius: 16, border: '1px solid rgba(148,163,184,0.18)', background: 'rgba(8,16,40,0.97)' }}>
                <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '16px 20px', borderBottom: '1px solid rgba(148,163,184,0.14)' }}>
                  <div>
                    <div style={{ fontSize: 15, fontWeight: 800, letterSpacing: 0, color: '#e2e8f0' }}>Loss Breakdown — Actual vs Projected</div>
