...
// Phase 3.2 hardening: shell + chrome come from the ui primitives (Modal,
// Badge); the screen-specific skin lives in AggDrilldownModal.css. The only
// inline styles left are genuinely dynamic (peril colors, meter widths).
import { useState, useEffect, useMemo } from 'react';
import { api } from '../../../../api';
import { Modal, Badge, PctInput } from '../../../../components/ui';
import { toN as cn } from '../../../../utils/format.js';
import './AggDrilldownModal.css';
  ...
  return (
    <Modal
      ...
      title={(
        <>
          ◈ Aggregate Analysis
          {data?.contract?.country_name && <span className="agg-title__meta">{data.contract.country_name} · UW {data.contract.uw_year}</span>}
