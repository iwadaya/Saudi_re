...
import { YearlyAggregatesModal, GrowthModal } from './LossSelectionModals';
          ...
          <AsyncBoundary loading={loading} error={loadError} onRetry={refetch} label="loss selection">
            <>
              ...
              {showGrowthModal && lossType === 'cat' && (
                <GrowthModal
                  growthMode={growthMode} setGrowthMode={setGrowthMode}
                  premiumByYear={premiumByYear} growthRates={growthRates} avgGrowth={avgGrowth}
                  manualGrowthPct={manualGrowthPct} setManualGrowthPct={setManualGrowthPct}
                  onApply={() => applyInflation('growth', growthMode === 'calculated' ? String(avgGrowth) : manualGrowthPct)}
