...
// it is NOT for lognormalCDF — wrap that with conditionalCDF() above before
// ranking. See the PDF note below and finding F-F in
...
/* ── PDFs ──────────────────────────────────────────────────────────────
   ...
   three unless wrapped with conditionalCDF() (as calcKS callers now do).
   See docs/actuarial-formula-verification-2026-08.md (F-F). ── */
