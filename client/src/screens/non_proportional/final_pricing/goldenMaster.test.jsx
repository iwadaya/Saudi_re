...
describe('NpFinalPricing golden master (quote mode)', () => {
  ...
  it('hydrates the expiring structure with the exact derived pricing', async () => {
    ...
    expect(rowsOf(expCard.querySelector('table'))).toEqual([
      ['#', 'Risk', 'Cat', 'Limit', 'Attachment', 'EGNPI', 'Rate %', 'ROL %', 'Premium', 'MDP', 'Reinst.', 'Geomean', 'x=G/E'],
      ['1', '[x]', '[ ]', '[400,000]', '[90,000]', '[800,000]', '[4%]', '8.00%', '32,000', '[5000]', '[1]', '210,000', '0.2625'],
  ...
  it('splits the exact risk/cat component analysis and totals', async () => {
    ...
    const componentRows = (scope) => [
      ['Layer', 'Active', 'Limit', 'Deductible', 'Pure Burn', 'Pareto', 'Exposure', 'Wt Burn %', 'Wt Pareto %', 'Wt Exp %', 'Loading %', 'Total ROL', 'UW Price'],
      ['1', '[x]', 'SAR 750,000', 'SAR 100,000', `[${scope}]`, '[0%]', `[${scope}]`, '[50%]', '[0%]', '50%', '[15%]', '62.73%', '[62.726%]'],
    ];
