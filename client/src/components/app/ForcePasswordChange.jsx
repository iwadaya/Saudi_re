...
export default function ForcePasswordChange() {
  ...
  return (
    <div role="dialog" aria-modal="true" aria-labelledby="force-pw-title"
      ...
      <div style={{ width: 'min(420px, 100%)', background: 'rgba(10,18,45,0.99)', border: '1px solid rgba(255,255,255,0.18)', borderRadius: 14, boxShadow: '0 24px 64px rgba(0,0,0,0.80)', padding: 22 }}>
        <div id="force-pw-title" style={{ fontSize: 16, fontWeight: 800, color: '#f8fafc', marginBottom: 6 }}>Set your password</div>
        <p style={{ fontSize: 13, lineHeight: 1.5, color: 'rgba(226,232,240,0.80)', margin: '0 0 16px' }}>
